...
* **📂 书签物理拆解**：将 `bookmarks.html` 一键拆分为本地文件夹和 `.url` 快捷方式。
* **🔗 智能合并重建**：将整理后的本地目录重新打包为标准的 Netscape 格式 HTML 书签。
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/20d16957-9574-4c7e-bfef-3cd479015a91" width="700" alt="软件截图">
</p>
